# image-mode-operational-updates

in this lab, you will learn how to manage updates for your image mode hosts.  You will start with a running bootc host, and the infrastructure to build a new bootc image, push it, and manage its automatic updates via the systemd bootc update service.
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/image-mode-operational-updates`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/image-mode-operational-updates
   ```
3. `cd image-mode-operational-updates`
